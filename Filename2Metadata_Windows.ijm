...
function processFolder(folder) {
    ...
    // Close the file using Bio-Formats
Ext.close();

// Rename and save the image file
if (File.rename(file, folder + newFilename)) {
    print("Successfully renamed: " + file + " to " + newFilename);
} else {
    print("Failed to rename: " + file + " to " + newFilename);
}
